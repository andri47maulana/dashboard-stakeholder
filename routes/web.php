...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('masterdata')->group(function(){
        ...
        Route::post('/data_kebun/store', [MasterDataController::class, 'store_unit'])->name('units.store');
        ...
        Route::post('/data_kebun/{id}/delete', [MasterDataController::class, 'delete_unit'])->name('units.delete');
