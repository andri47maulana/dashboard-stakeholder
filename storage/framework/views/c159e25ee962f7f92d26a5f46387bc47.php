...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let kebunJsons = <?php echo json_encode($kebunJsons, 15, 512) ?>;
    let polygonLayers = {};
    ...
    document.getElementById("checkPointForm").addEventListener("submit", function(e){
        ...
        fetch("<?php echo e(route('polygons.check')); ?>", {
            method: "POST",
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\dashboard-stakeholder\resources\views/polygon/index.blade.php ENDPATH**/ ?>