            ...
            <div class="col-md-12">
                ...
                <div class="tree-panel">
                    ...
                    <ul id="treeMenu" class="list-unstyled small">
                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                ...
                                <ul class="unit-list ms-3" style="display:none;">
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="javascript:void(0)" class="tree-link" data-unit="<?php echo e($unit->id); ?>" style="font-size:12px;">
...
$(document).on("click",".tree-link", function(e){
    ...
    var allDerajat = <?php echo json_encode($derajatHubungan, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\dashboard-stakeholder\resources\views/peta/peta.blade.php ENDPATH**/ ?>